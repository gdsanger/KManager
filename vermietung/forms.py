...
class AktivitaetForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'privat': forms.CheckboxInput(attrs={'class': 'form-check-input', 'id': 'id_privat'}),
        ...
        help_texts = {
            ...
            'privat': 'Private Aktivitäten sind nur für den Ersteller und Verantwortlichen sichtbar',
