...
def cost_type_2_options(request):
    ...
    # A fresh form renders the field without a selection, so a previously chosen
    # Unterkostenart of the old Hauptkostenart cannot survive the swap.
    form = ItemForm()
    form.set_cost_type_2_choices(cost_type_1_id)
